...
urlpatterns = [
    ...
    path('place_delete/', views.PlaceDelete, name='place_delete'), 
    ...
    path('book_manage/', views.book_manage, name="book_manage"),
    ...
    path('borrowed_list/', views.borrowed_books_list, name='borrowed_books_list'),
