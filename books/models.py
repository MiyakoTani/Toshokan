...
class Book(models.Model):
    isbn = models.CharField(max_length=1000, blank=True, null=True)
    title = models.CharField(max_length=1000)
    titlekana = models.CharField(max_length=1000, blank=True, null=True)
    author= models.CharField(max_length=1000)
    authorkana = models.CharField(max_length=1000, blank=True, null=True)
    ...
    pubkana = models.CharField(max_length=1000, blank=True, null=True)
...
class Review(models.Model):
    ...
    rating = models.PositiveIntegerField(validators=[MinValueValidator(1), MaxValueValidator(5)],default=5)  # 評価(1～5)
